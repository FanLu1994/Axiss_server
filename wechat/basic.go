...
//GetAccessToken 获取ak
func (ex *MyOfficialAccount) GetAccessToken(c *gin.Context) {
...
func (ex *MyOfficialAccount) GetCallbackIP(c *gin.Context) {
...
func (ex *MyOfficialAccount) GetAPIDomainIP(c *gin.Context) {
...
func (ex *MyOfficialAccount) ClearQuota(c *gin.Context) {
